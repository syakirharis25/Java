...
To setup javac in windows environment, on the right hand side of **[ ⊞ ]**, type `edit environment` and then **[ Mouse Left Click ]** the shown text `edit environment variables for your account`, the **System Properties** menu will appear on the screen, then press **[ N ]** on your keyboard to open **Environment Variables** menu, press **[ Tab ]**, **[ N ]**, type `Java_home`, then press **[ Tab ]**, type `C:\Program Files\Java\jdk-12.0.2`, then press **[ Enter ]**, then press **[ Tab ]** 10x, the press **[ P ]**, make sure the `Path` is highlighted on the screen and then press **[ Tab ]**, **[ E ]**, **[ Tab ]**, **[ N ]**, then type `C:\Program Files\Java\jdk-12.0.2\bin`, then press **[ Enter ]**, press **[ Tab ]** 6x, then press **[ Enter ]**, **[ Tab ]**, **[ Enter ]**.
